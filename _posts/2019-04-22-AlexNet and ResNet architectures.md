...
published: false
layout: post
title: AlexNet and ResNet architectures
---
# AlexNet

To catch on CNN architecture development, you may start with AlexNet (2012). When it came out [AlexNet](https://papers.nips.cc/paper/4824-imagenet-classification-with-deep-convolutional-neural-networks.pdf) won the ImageNet competition (ImageNet 2012).

At that time we had Conv2d and MaxPooling2d as well as ReLU nonlinearity. For the AlexNet 2012 total 5 convolution layers.
```
AlexNet(
  (features): Sequential(
...
Here is a demo how MaxPool2d works
```
import torch
import torch.nn as nn
import torch.nn.functional as F

input = torch.randn(1,4,4).random_(0,50)
print(input)
...
print(output)
```
The output I had looks like this:
