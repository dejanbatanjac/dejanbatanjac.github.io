...
The key feature traditional CNNs have is they are equivariant with respect to translation. This means if you have the cat on an image, the CNN will recognize the cat no matter where the cat is positioned as well it is not rotated. This is an important feature and it reflects on CNNs being super practical for modern image tasks: image segmentation, object detection, and classification no matter where the object is located in the image.
