...
The last line of the `step` method updates current parameter based on the learning rate and also based on the average gradient. 

This last line is basic gradient descent formula, with our gradient dumpened and debiased.
