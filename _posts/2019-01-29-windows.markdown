...
*   <small>RemoteSigned — Runs scripts created on the device. </small>However, scripts created on another computer won't run unless they include a signature of a trusted publisher.</small>
